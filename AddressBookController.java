...
public class AddressBookController {
    ...
    public void control(){
        ...
        int confirmed = JOptionPane.showConfirmDialog(
                null,
                "Exit Program?","EXIT",JOptionPane.YES_NO_OPTION);
    ...
    private void openAdd(){  
       view.getMainGUIFrame().setVisible(false);
        ...
        choiceListener = new ActionListener() {
            ...
            String state = contactDetailsPanel.getStateField().getText();
            
            flag = validate();
            if(flag)
            {    
             Person person = new Person();
             person.setData(name,mobile,email,address,city,state);
   ...
   */
    ...
    private void openEdit(){
        ...
        dialog.getPanel().setState(detailPanel.getStateField().getText());
        view.getMainGUIFrame().setVisible(false);
        choiceListener = new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
    ...
    public void loadPersons()      
    {
        ...
        nlp.getJList().addListSelectionListener(new ListSelectionListener()
         ...
         detailPanel.getStateField().setEditable(false);
        }
    }  //loadPersons ends
